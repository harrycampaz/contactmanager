...
public class MainActivity extends AppCompatActivity {
   ...
   // private DatabaseHelper db;
    ...
    private void deleteContact(Contact contact, int position) {
        ...
        new DeleteContactAsyncTack().execute(contact);
    ...
    private  class  GetAllContactsAsyncTesk extends AsyncTask<Void, Void, Void>{
    ...
    private  class  DeleteContactAsyncTack extends  AsyncTask<Contact, Void, Void>{
    ...
    RoomDatabase.Callback callback = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            createContact("Harry Campaz", "har@mail.com");
            createContact("lucas leica", "lucas@mail.com");
            createContact("anderson lopez", "anlo@mail.com");
        }
